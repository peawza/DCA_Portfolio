var ui = {
    ...
    Input: {
        //Readonly: function (Selector, enable, condition) {

        //    const from = document.getElementById(Selector);
        //    var TagInput = Array.from(from.getElementsByTagName('input'));
        ...
        Disable: async function (Selector, enable, condition) {
            ...
            TagInput.forEach(input => {
                ...
                } else if (input.getAttribute("data-role") === "switch") {
                    $("#" + input.getAttribute("id")).data("kendoSwitch").enable(enable);
                }
            });

            var TagInputTextarea = Array.from(await from.getElementsByTagName('textarea'));
        ...
        DisableCondition: async function (Selector, enable, condition) {
            ...
            TagInputTextarea.forEach(input => {
                if (condition.includes(input.id)) {
        ...
        , Clear: async function (Selector, arrowFunction) {
            ...
            try {
                ...
                var TagInput = Array.from(from.getElementsByTagName('input'));
                var textArea = Array.from(from.getElementsByTagName('textarea'));
                ...
                TagInput.forEach(input => {
                    ...
                    if (id) IdClearData.push("#" + id);
                });

                // Collect textarea IDs
