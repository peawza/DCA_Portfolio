...
namespace WEB.APP
{
    ...
    {
        private static IMessageResources _resources;

        public static void Configure(IMessageResources resources)
        {
        ...
        {
            return helper.CommandButton(name, _resources["COMMON", "SEARCH"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-primary" })).Icon("search");
        }


        public static ButtonBuilder DowntimeButton<TModel>(this IHtmlHelper<TModel> helper, string name = "downtime-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, _resources["COMMON", "DOWNTIMEBUTTON"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-primary" }));
        }
        ...
        {
            return helper.CommandButton(name, _resources["COMMON", "CLEAR"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "mes-clear" })).Icon("clear");
        }
        ...
        {
            return helper.CommandButton(name, _resources["COMMON", "IMPORTBUTTON"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-dark d-none d-md-inline" })).Icon("upload");
        }
        ...
        {
            return helper.CommandButton(name, UIResource.Add, HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-dark" })).Icon("plus-circle");
        }
        ...
        {
            return helper.CommandButton(name, UIResource.Submit, HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-dark" })).Icon("button");
        }
        ...
        public static ButtonBuilder NewAreaButton<TModel>(this IHtmlHelper<TModel> helper, string name = "new-area-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, _resources["COMMON", "NewArea"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-success view-mode-check-new", @style = "min-width:80px" })).Icon("plus-circle");
        }

        public static ButtonBuilder InactiveButton<TModel>(this IHtmlHelper<TModel> helper, string name = "inactive-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, _resources["COMMON", "Inactive"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-danger" })).Icon("close");
        }

        public static ButtonBuilder ReStatusButton<TModel>(this IHtmlHelper<TModel> helper, string name = "re-status-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, _resources["COMMON", "ReStatus"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-danger" })).Icon("check-circle");
        }

        public static ButtonBuilder GenFileButton<TModel>(this IHtmlHelper<TModel> helper, string name = "gen-file-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, _resources["COMMON", "GenFile"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-success" })).Icon("download");
        }

        public static ButtonBuilder RePrintButton<TModel>(this IHtmlHelper<TModel> helper, string name = "re-print-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, _resources["COMMON", "RePrint"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-danger" })).Icon("print");
        }

        public static ButtonBuilder ConfirmButton<TModel>(this IHtmlHelper<TModel> helper, string name = "confirm-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, _resources["COMMON", "Confirm"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-primary" })).Icon("check-circle");
        }

        public static ButtonBuilder RemoveButton<TModel>(this IHtmlHelper<TModel> helper, string name = "remove-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, UIResource.Remove, HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-danger" })).Icon("trash");
        }

        public static ButtonBuilder BackButton<TModel>(this IHtmlHelper<TModel> helper, string name = "back-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, UIResource.Back, HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-dark" })).Icon("chevron-left");
        }

        public static ButtonBuilder DownloadSampleFileButton<TModel>(this IHtmlHelper<TModel> helper, string name = "download-sample-file-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, _resources["COMMON", "DownloadSampleFile"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-dark" })).Icon("download");
        }

        public static ButtonBuilder ReceiveButton<TModel>(this IHtmlHelper<TModel> helper, string name = "receive-button", object htmlAttributes = null)
        {
            return helper.CommandButton(name, _resources["COMMON", "Receive"], HtmlAttributeHelper.MergeHtmlAttributes(htmlAttributes, new { @class = "k-dark" })).Icon("save");
        }
