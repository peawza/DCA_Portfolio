    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JobLogId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    InterfaceCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    InterfaceName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    FtpServername = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    FileFolder = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    InterfaceFilename = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    JobStatus = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ProcessBy = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorDetail = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModuleNameEN = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ModuleNameTH = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainMenuFlag = table.Column<bool>(type: "boolean", nullable: false),
                    PermissionFlag = table.Column<bool>(type: "boolean", nullable: false),
                    Seq = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubModuleNameEN = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    SubModuleNameTH = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Seq = table.Column<int>(type: "integer", nullable: false),
                    IconClass = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfigDesc = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ValueVarchar = table.Column<string>(type: "text", nullable: true),
                    ValueVarchar2 = table.Column<string>(type: "text", nullable: true),
                    ValueVarchar3 = table.Column<string>(type: "text", nullable: true),
                    ...
                    ValueDecimal = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
