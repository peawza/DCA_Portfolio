...
namespace Authentication.Services
{
    ...
    public class OtpRepository : IOtpRepository
    {
        ...
        public OtpRepository(ApplicationUserManager userManager, ApplicationDbContext db, SystemDbContext systemDbContext, IEmailService emailService)
        {
        ...
        CancellationToken ct = default)
        {
            ...
            await SendOTPLogin(new SendOTPLogin_Criteria
            {
                Email = user.Email,
        ...
        public async Task<SendOTPLogin_Result> SendOTPLogin(SendOTPLogin_Criteria criteria)
        {
            try
            {
