...
namespace Authentication.Repositories
{
    ...
    public class UMS010Repository : IUMS010Repository
    {
        ...
        public UMS010Repository(ApplicationDbContext db, SystemDbContext systemDbContext, IMapper mapper, ApplicationUserManager userManager, IEmailService emailService)
        {
            _db = db;
            _mapper = mapper;
        ...
        public async Task<List<UMS010_Search_Result>> UMS010_Search(UMS010_Search_Criteria criteria)
        {
            ...
            var query = from user in _db.ApplicationUsers
                        ...
                        select new UMS010_Search_Result
                        {
                            ...
                            DepartmentCode = dep != null ? dep.DepartmentCode : null,
                            DisplayDepartment = dep != null ? dep.DepartmentName : null,
