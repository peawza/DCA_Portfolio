    ...
    public class SSS010Controller : ControllerBase
    {
        ...
        public async Task<IActionResult> VerifyLogin([FromBody] Models.UserLoginDo oUser)
        {
            try
            {
                ...
                string token = await this.signInManager.GenerateToken(appUser, userInfo.LanguageCode, oUser.Device);
        ...
        public async Task<IActionResult> VerifyOtp([FromBody] VerifyOtpRequest request, CancellationToken ct)
        {
            ...
            string token = await this.signInManager.GenerateToken(appUser, userInfo.LanguageCode, request.Device);
            string rtoken = await this.userManager.GenerateRefreshTokenAsync(appUser);
        ...
        public async Task<IActionResult> RefreshToken([FromBody] Models.RefreshTokenDo oToken)
        {
            ...
            string token = await this.signInManager.GenerateToken(appUser, userInfo.LanguageCode, device);
            string rtoken = await this.userManager.GenerateRefreshTokenAsync(appUser);
